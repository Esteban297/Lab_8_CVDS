...
public class ServiciosAlquilerItemsStub implements ServiciosAlquiler {
   ...
   public Cliente consultarCliente(long docu) throws ExcepcionServiciosAlquiler {
       ...
       if(clientes.containsKey(docu)){
           ...
           throw new ExcepcionServiciosAlquiler(ExcepcionServiciosAlquiler.NO_CLIENT_REGISTRED);
       }
       return c;
   }
   ...
   public TipoItem consultarTipoItem(int id) throws ExcepcionServiciosAlquiler {
       ...
       if(!tipositems.containsKey(id)){
           ...
           throw new ExcepcionServiciosAlquiler(ExcepcionServiciosAlquiler.NO_ITEM_TYPE);
       }
       return i;
   ...
   public long consultarMultaAlquiler(int iditem,Date fechaDevolucion) throws ExcepcionServiciosAlquiler{
       if (!itemsrentados.containsKey(iditem)){
           ...
           verificarFechas(fechaInicioRenta, fechaEntrega);
